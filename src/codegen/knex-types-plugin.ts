...
function generateEnum(type: any): string {
...
function generateInterface(type: any): string {
...
function generateKnexModuleDeclaration(types: any[]): string {
...
function convertToDatabaseFieldName(fieldName: string): string {
...
function convertToTableName(typeName: string): string {
...
function mapGraphQLTypeToTypeScript(type: any): string {
